/*
  ...
  开发者：Dedcirc
  版本：0.0.5F
  Manual：基于节点矩阵算法的电力系统故障分析程序。帮助开发者完善程序请联系ionsuite@gmail.com
 */
...
void Read_data(int argc,char **argv)                             /* 读取原始数据 */
{
  int i,j;
